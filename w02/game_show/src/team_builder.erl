...
random_list_test_() ->
	Random_numbers = [rand:uniform(10) || _ <- lists:seq(1,10)], %[rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10)],%replace this with the list of 10 random integers 
...
person_tuple_list_test_() ->
	People = [{sally, female, 2}, {joe, male, 22}, {barbra, female, 2}, {kendra, female, 3}, {jacky, male, 5}, {jackson, male, 1}, {fin, female, 4}, {bren, male, 34.8530}],%replace this with the list of tuples described in the previous comment
